...
//                title = {
//                    Text(text = "Make a report", fontSize = 30.sp, color = Color.White)
//                },
//                navigationIcon = {
//                    IconButton(onClick = {
...
//                        Text("Incident Description is required", color = Color.Red)
//                    }
//                    if (productPriceError) {
//                        Text("Location is required", color = Color.Red)
//                    }
//                    if (productImageError) {
//                        Text("Incident Image is required", color = Color.Red)
//                    }
//
